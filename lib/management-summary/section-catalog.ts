...
export const MANAGEMENT_SUMMARY_SECTION_GROUPS: ManagementSummarySectionGroup[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        label: "Notifications by month",
        description: "Bar chart with total notifications by month (rolling view).",
        exportable: true,
      },
      {
        id: "chart-defects-month",
        label: "Defective parts by month",
        description: "Bar chart with defective parts by month.",
        exportable: true,
      },
      {
        id: "chart-notifications-type",
        label: "Notifications by type (Q1 / Q2 / Q3)",
        description: "Stacked bar chart with notifications split by Q1, Q2 and Q3 over time.",
        exportable: true,
      },
      {
        id: "customer-ppm",
